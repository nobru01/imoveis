...
def impota_dados(path):
    ...
    Args.:
        path => ex.: './sqs205_blocok_ap302/input_fluxo_caixa_sqs205_blocok_ap302.csv'
    '''    
    df_input=pd.read_csv(path,header=None,index_col=0)
    df_input=df_input.rename(columns={1:'valor_variavel'})
    return df_input

df_input=impota_dados('./sqs205_blocok_ap302/input_fluxo_caixa_sqs205_blocok_ap302.csv')
